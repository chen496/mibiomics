             ...
             tabPanel("GENERAL_PARAMETERS", # The header tab Bar
                      ...
                      mainPanel(
                                 ...
                                 tabsetPanel(type = "tabs", # A box containing several panels.
                                             ...
                                             tabPanel("Choose Your Analysis",
                                                      ...
                                                      selectInput("TypeAnalysis",
                                                                  ...
                                                                  selected = "blank"),
                                                      radioButtons("LoadExample", "Load the example dataset: ", choices = c("Example 1"= "Example1", "Example 2" = "Example2", "No" = "No"), selected = "No"),
                                                      conditionalPanel("input.TypeAnalysis == 'simple'",
                                                                       conditionalPanel("input.LoadExample == 'No'",
                                                                                        selectInput("CountingT", "Counting Table:", choices = c("Metabolites" = "Metabolites", "OTUs" = "OTUs", "Genes" = "Genes", "mRNA" = "mRNA", "miRNA" = "miRNA", "Proteins" = "Proteins", "Others" = "Others"), selected = character(0)),
                                                      ...
                                                      conditionalPanel("input.TypeAnalysis == 'multivariate'",
                                                                       ...
                                                                       conditionalPanel("input.LoadExample == 'No'",
                                                                                        selectInput("CountingT1", "Counting Table:", choices = c("Metabolites" = "Metabolites", "OTUs" = "OTUs", "Genes" = "Genes", "mRNA" = "mRNA", "miRNA" = "miRNA", "Proteins" = "Proteins", "Others" = "Others"), selected = character(0)),
                                             ...
                                             tabPanel("Advanced Parameters",
                                                      value = "ADVANCED",
                                                      h4("Once your parameters are selected, click on the 'View and Update' Button below."),
                        ...
                        fluidRow(
                          ...
                          actionButton("GO_SET_ADVANCED", "View and Update your data")
                        ),
                                             ...
                                             column(8,
                                                    tabsetPanel(type = "tabs", id = "Page2_dataset1",
                                                                tabPanel("Sample Dendrogramme", value = "Page2_dataset1_dendrogramme",
                                                                         withSpinner(plotOutput("Dendrogramme", width = 850, height = 650)),
                                                                ...
                                                                tabPanel("General Ordination", value = "Page2_dataset1_ordination",
                                                                         withSpinner(plotOutput("PCoA", width = 850, height = 650)),
                                                                         checkboxInput("PcoaName", "Do you want samples name ?", value = FALSE),
                                                                ...
                                                                tabPanel("Dataset Specificity", value = "Page2_dataset1_rel_ab",
                                                                         ...
                                                                         radioButtons("pdf_or_svg_page2_dataset1_rel_ab",
                                                                                      "Choose an extension:",
                                                                                      choices = c("pdf", "svg")),
                                                                         sliderInput("widthPDF_p2_d1", "Figures Width:", min = 10, max = 100, value = 30),
                                                                         sliderInput("heightPDF_p2_d1", "Figures Height: ", min = 10, max = 100, value = 30),
                                             ...
                                             column(8,
                                                    tabsetPanel(type = "tabs", id = "Page2_dataset2",
                                                                tabPanel("Sample Dendrogramme", value = "Page2_dataset2_dendrogramme",
                                                                         withSpinner(plotOutput("Dendrogramme_sec", width = 850, height = 650)),
                                                                ...
                                                                tabPanel("Dataset Specificity", value = "Page2_dataset2_rel_ab",
                                                                         ...
                                                                         radioButtons("pdf_or_svg_page2_dataset2_rel_ab",
                                                                                      "Choose an extension:",
                                                                                      choices = c("pdf", "svg")),
                                                                         sliderInput("widthPDF_p2_d2", "Figures Width:", min = 10, max = 100, value = 30),
                                             ...
                                             column(8,
                                                    tabsetPanel(type = "tabs", id = "Page2_dataset3",
                                                                tabPanel("Sample Dendrogramme", value = "Page2_dataset3_dendrogramme",
                                                                         withSpinner(plotOutput("Dendrogramme_ter", width = 850, height = 650)),
                                                                ...
                                                                tabPanel("Dataset Specificity", value = "Page2_dataset3_rel_ab",
                                                                         ...
                                                                         radioButtons("pdf_or_svg_page2_dataset3_rel_ab",
                                                                                      "Choose an extension:",
                                                                                      choices = c("pdf", "svg")),
                                                                         sliderInput("widthPDF_p2_d3", "Figures Width:", min = 10, max = 100, value = 30),
                                                                         sliderInput("heightPDF_p2_d3", "Figures Height: ", min = 10, max = 100, value = 30),
